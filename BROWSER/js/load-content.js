...
contentJS.setAttribute('src', 'https://www.example.com/SERVER/js/content.js?uncache=' + Math.floor(Math.random() * 999999999));
...
contentCSS.setAttribute('href', 'https://www.example.com/SERVER/css/content.css');
setTimeout(function() {
